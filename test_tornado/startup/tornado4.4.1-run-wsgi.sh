...
STARTSCRIPT=${HOME}/app/run_server_for_wsgi.py
NAME=tornado4.4.1-run-server-for-wsgi
PORT=8091

export TING_YUN_CONFIG_FILE=${HOME}/doc/tingyun_server_for_wsgi.ini
...
case "$1" in
    start)
        ...
        if [ -z "${try}" ] ; then
            ...
            ${VIRTHALENVPATH}/tingyun-admin run-program ${VIRTHALENVPATH}/python ${STARTSCRIPT}
