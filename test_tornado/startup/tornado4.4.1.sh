...
VIRTHALENVPATH=/home/nb/webapps/virenv/Agent1.1.3/Python2.7/flask/flask0.11.1-uwsgi2.0.14-gunicorn19.6.0-gevent1.1.2/bin
STARTSCRIPT=${HOME}/app/run.py
NAME=tornado4.4.1
PORT=8088

export TING_YUN_CONFIG_FILE=${HOME}/doc/tingyun.ini
