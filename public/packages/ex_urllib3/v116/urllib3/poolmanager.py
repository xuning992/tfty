    ...
    def urlopen(self, method, url, redirect=True, **kw):
        ...
        if error_type:
            ...
            get_error = {
                ...
                "HostChangedError": HostChangedError(pool=1, url=2),
                "LocationParseError": LocationParseError(url),
                "ConnectTimeoutError": ConnectTimeoutError(),
                "ProxyError": ProxyError(),
                "TimeoutError": TimeoutError(),
                "ReadTimeoutError": ReadTimeoutError(pool=1, url=2, message="ReadTimeoutError"),
                ...
                "PoolError": PoolError(pool=1, message=2),
                "RequestError": RequestError(pool=1, url=2, message="RequestError"),
                "MaxRetryError": MaxRetryError(pool=1, url=2, reason=None),
                "TimeoutStateError": TimeoutStateError(),
                "NewConnectionError": NewConnectionError(pool=1, message="NewConnectionError"),
                "EmptyPoolError": EmptyPoolError(pool=1, message="EmptyPoolError"),
                "ClosedPoolError": ClosedPoolError(pool=1, message="ClosedPoolError"),
                ...
                "ProxySchemeUnknown": ProxySchemeUnknown(scheme=1),
                "HeaderParsingError": HeaderParsingError(defects=1, unparsed_data=2)
            }
