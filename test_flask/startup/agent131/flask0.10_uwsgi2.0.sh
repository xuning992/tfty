...
export TING_YUN_CONFIG_FILE=${BASE}/tfty/test_flask/config/flask0.10_uwsgi2.0_agent1.3.1.ini
NAME=flask0.10_uwsgi2.0
HOME=${BASE}/tfty/test_flask
PID=${BASE}/staticfiles/pids/agent131/${NAME}.pid
# CMD=$1
CMD_ARGS="-M -p 1 -b 32767 -z 20 --threads 20 --max-request 16384 --listen 100 --limit-post 1048576 --logdate --disable-logging"
PORT=5592
LOGFILE=${BASE}/logs/test_flask/agent131/flask0.10_uwsgi2.0.log
VIRTUALENV=/home/nb/webapps/virenv/Agent1.3.1/Python2.7/flask/flask0.10-uwsgi2.0-gunicorn18.0-gevent1.0
