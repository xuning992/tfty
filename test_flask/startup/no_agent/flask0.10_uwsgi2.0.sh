...
case "$1" in
    start)
        ...
        ${CMD} ${CMD_ARGS} --chdir ${HOME} --wsgi-file main_flask.py --callable application --socket :${PORT} -d ${LOGFILE} --pidfile ${PID}
