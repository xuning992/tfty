...
_urlopener = None
def urlopen(url, data=None, proxies=None, context=None, **kwargs):
...
class URLopener:
    ...
    # External interface
    def open(self, fullurl, data=None, **kwargs):
        ...
        if error_type:
            print error_type
            if error_type == "ContentTooShortError":
                raise ContentTooShortError(message=1, content=2)
            else:
                raise IOError
        #===============================================================================================================
