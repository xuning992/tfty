...
gunicorn_version = "17.5"  # 17.x-19.x.x
...
# package`s version
cx_oracle_version = "5.2.1"
mysql_python_version = "1.2.5"
psycopg2_version = "2.4"
requests_version = "2.10.0"
django_piston_version = "0.2.3"
simplejson_version = "3.10.0"
# add packages


packages = [framework_name, 'psycopg2', 'MySQL-python', 'requests', 'uWSGI', 'gevent', "gunicorn", "cx_oracle",
            "django-piston", 'simplejson']
...
versions = {
    ...
    'django-piston': django_piston_version,
